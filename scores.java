...
public class scores {
	...
	public static void main(String[] args)  {
		...
		do {
			...
			System.out.println("How many points would you like to add? (Enter '1234' to see the scoring rules)");
	...
	public static void getPlayers(Scanner input, TreeMap<String, Integer> scores) {
	...
	/**
	 * This method adds points to the specified player
	 * @param input
	 * @param scores
	 * @param playerName
	 * @param points
	...
	public static void addPoints(Scanner input, TreeMap<String, Integer> scores, String playerName, int points) {
	...
	/**
	 * This method prints out the scoring rules for the game
	 * @param input
	 */
